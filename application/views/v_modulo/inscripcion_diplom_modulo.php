    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                    <center>
                        <h3 class="page-header">Asignacion de Modulo</h3>
                    </center>
                </div>
                    ...
                    <form method="post" id="formasigmodulo">
                        <div class="row">
                            <div class=" form-inline col-md-3 col-md-offset-1 ">
                                <small><label for="">Inscripcion: </label>
                                    <p type="" class="" value="" name="numInscripcion" id="numInscripcion"><?= $diplomanteinscrito[0]['numeroI']; ?></p>
                                </small>

                            </div>
                            <div class=" form-inline col-md-3">

                                <small><label for="">CI: </label>
                                    <p type="" class="" value="" name="ciDiplomante" id="ciDiplomante"><?= $diplomanteinscrito[0]['ciD']; ?></p>
                                </small>
                            </div>
                                ...
                                <select type="text" class="form-control " id="modulosele" name="modulosele">
                                    ...
                                    <?php foreach ($modulo as $modulito) : ?>
                                        <option value="<?= $modulito['numeroM']; ?>">
                                            ( <?= convertirANumerosRomanos($modulito['nivelM']) .  " - ". $modulito['nombreM'] . " ) "; ?><?= $modulito['asignaturaNombreM']; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-11 col-md-offset-1">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <center>
                                        <h5 class="page-header">Participantes sin Modulo</h5>
                                    </center>
