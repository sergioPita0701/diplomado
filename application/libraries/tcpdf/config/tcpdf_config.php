 ...
 */
define('PDF_HEADER_LOGO', 'FacultadDeHumanidadesYCienciasDeLaEducacion.jpg');
define('PDF_HEADER_LOGO_WIDTH', 16);

// Configuración del logo derecho
define('PDF_HEADER_LOGO_RIGHT', 'UnidadDePosgrado.jpg');
define('PDF_HEADER_LOGO_RIGHT_WIDTH', 16);
 ...
 */
define('PDF_HEADER_STRING', "Unidad Facultativa de Posgrado de Humanidades y Ciencias de la Educación\n");
