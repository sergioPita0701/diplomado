...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE.'Lista de Monografias en la '.$nombre, PDF_HEADER_STRING);
...
$tabla='<table border="1" cellspacing="3" cellpadding="4">
        <tr style="background-color:#efefef;">
            ...
            <th align="center"><strong>F.Inicio</strong></th>
            <th align="center"><strong>F. Final</strong></th>
        </tr>';
    $no=1;
    foreach($listamonos as $filita ) {
$tabla.=        
    '<tr>
        <td>'.$no++.'</td>
        <td>'.$filita['ciD'].'</td>
        ...
        <td align="center">'.$filita['fecha_finalMo'].'</td>
    </tr>';
    }
