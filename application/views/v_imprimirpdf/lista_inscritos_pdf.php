...
$pdf->SetAuthor('eli');
$pdf->SetTitle('TCPDF Lista_Inscritos');
$pdf->SetSubject('TCPDF Tutorial');
$pdf->SetKeywords('TCPDF, PDF, example, test, guide');

// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE.'Lista de Inscritos en la '.$nombre, PDF_HEADER_STRING);
...
$tabla='<table border="1" cellspacing="3" cellpadding="4">
        <tr style="background-color:#efefef;">
            ...
            <th align="center"><strong>Profesion</strong></th>
            <th align="center"><strong>Ciudad</strong></th>
    ...
    $no=1;
    foreach($listainscritos as $filita ) {
$tabla.=        
    '<tr>
        <td>'.$no++.'</td>
        <td>'.$filita->ciI.'</td>
        <td align="center">'.$filita->nombreD." ".$filita->apellidoPaternoD." ".$filita->apellidoMaternoD.'</td>
        <td align="center">'.$filita->nombreP.'</td>
        <td align="center">'.$filita->departamentonacI.'</td>
        <td align="center">'.$filita->direccionI.'</td>
        <td align="center">'.$filita->telefonoI.'</td>
        <td align="center">'.$filita->emailI.'</td>
    </tr>';
    }
