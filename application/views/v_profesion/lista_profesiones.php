<!-- <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 ">
    <div class="row">
    <div class="col-md-10">
        <form class="form" role="form" action="http://localhost:8080/diplomado/index.php/profesion/crearProfesion" method="post">
        ...
        <div class="col-md-10 col-md-offset-1 main">
            ...
            <div class="row">
                ...
                <div class="form-inline col-md-8" style="text-align:right">
                    <form action="http://localhost:8080/diplomado/index.php/profesion/buscarProfesion" method="post">
                                    ...
                                    <div class="modal fade" id="modalProfesion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="http://localhost:8080/diplomado/index.php/profesion/editarProfesion" method="POST" role="form">
