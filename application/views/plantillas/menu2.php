    <nav style="background-color: #2d2d2d;width: 210px;height: 100%;position:absolute;">
    <div class="be-left-sidebar">
        <div class="left-sidebar-wrapper"><a href="#" class="left-sidebar-toggle">Dashboard</a>
          <div class="left-sidebar-spacer" style="">
            <div class="left-sidebar-scroll ps-container ps-theme-default ps-active-y" data-ps-id="000b4587-586b-f0cc-a64e-0fb6d826914f">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent open"><a href="charts.html"><i class="icon mdi mdi-chart-donut"></i><span>Charts</span></a>
                    <ul class="sub-menu">
