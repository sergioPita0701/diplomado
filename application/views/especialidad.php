                    ...
                    <div class="panel-body panel-collapse collapse" id="collapseEspecialidad">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control input-sm" name="txtNombreEs"
                                    placeholder="Ej.Doctorado, Maestria, etc." /></br>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea wrap="hard" class="form-control input-sm" name="txtDescripcionEs" id=""
                                    rows="4" placeholder="Ej. El programa consiste en el estudio..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody style="display: block; height: 280px; overflow-y: auto; overflow-x: hidden;">
                        ...
                        <tr>
                            ...
                            <td style="width:100px; word-break:break-word">
                                <!-- Button modal -->
                                <b href="<?= base_url(); ?>index.php/especialidad/obtenerId?nombre=<?= $fila['nombreE']; ?>"
                                    type="button" class="btn btn-success btn-group btn-xs">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-10 col-md-offset-1">
                                                            <input type="hidden" id="idespecialidadEdi"
                                                                name="txtidespecialidadEdi"
                                                                class="form-control input-sm">
                                                            <label for="txtnombre">Nombre de Especialidad:</label>
                                                            <input type="text" id="nombreedit" name="txtnombreedit"
                                                                class="form-control">
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10 col-md-offset-1">
                                                            ...
                                                            <textarea class="form-control input-sm"
                                                                id="descripcionEedit" name="txtDescripcionEedit"
                                                                rows="4"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <a href="<?= base_url(); ?>index.php/especialidad/eliminarEspecialidad?nombre=<?= $fila['nombreE']; ?>"
                                    onclick="return confirm('Desea Eliminar Especialidad?')"
                                    class="btn btn-danger btn-group btn-xs">
