...
if (!defined('PDF_HEADER_LOGO_RIGHT')) {
	$tcpdf_header_logo_right = '';
	if (@file_exists(K_PATH_IMAGES . 'tcpdf_logo_right.jpg')) {
		$tcpdf_header_logo_right = 'tcpdf_logo_right.jpg';
	}
	define('PDF_HEADER_LOGO_RIGHT', $tcpdf_header_logo_right);
}

if (!defined('PDF_HEADER_LOGO_RIGHT_WIDTH')) {
	if (!empty($tcpdf_header_logo_right)) {
		define('PDF_HEADER_LOGO_RIGHT_WIDTH', 30);
	} else {
		define('PDF_HEADER_LOGO_RIGHT_WIDTH', 0);
	}
}

// Configuración del logo izquierdo (asegúrate de tener esta configuración)
