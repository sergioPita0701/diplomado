            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <form action="http://localhost:8080/diplomado/index.php/paralelo/crearParalelo" method="POST" class="form-horizontal" role="form">
                            <div class="row">
                                <div class="panel panel-default">
                                    <div class="panel-body ">
                                        <div class="row ">
...
<div class="modal fade" id="modalEditarParalelo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <!-- <form action="http://localhost:8080/diplomado/index.php/paralelo/editarParalelo" method="POST" role="form"> -->
