            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-2 col-md-offset-1">
                        <a href="http://localhost:8080/diplomado/index.php/version_cerrada/lista_academico_imprimir/?nombrev=<?= $nombre ?>"><span class="glyphicon glyphicon-download-alt"></span> Imprimir</a>
                    </div>
                </div>
                <hr>
