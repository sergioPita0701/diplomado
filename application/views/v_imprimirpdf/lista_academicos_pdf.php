...
$pdf->SetAuthor('eli');
$pdf->SetTitle('TCPDF Lista_academico');
$pdf->SetSubject('TCPDF Tutorial');
$pdf->SetKeywords('TCPDF, PDF, example, test, guide');

// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE.'Lista de Academicos de la '.$nombre, PDF_HEADER_STRING);
...
$tabla='<table border="1" cellspacing="3" cellpadding="4">
        <tr style="background-color:#efefef;">
            ...
            <th align="center"><strong>Carpeta</strong></th>
            <th align="center"><strong>Direccion</strong></th>
            <th align="center"><strong>Descripcion</strong></th>
        </tr>';
    $no=1;
    foreach($academicoseleccionado as $filita ) {
$tabla.=        
    '<tr>
        <td>'.$no++.'</td>
        <td>'.$filita['ciA'].'</td>
        <td align="center">'.$filita['nombreA'].'</td>
        <td align="center">'.$filita['ciudadA'].'</td>
        <td align="center">'.$filita['telefonoA'].'</td>
        <td align="center">'.$filita['numFolioA'].'</td>
        <td align="center">'.$filita['direccionA'].'</td>
        <td align="center">'.$filita['descripcionA'].'</td>
    </tr>';
    }
