...
$pdf->SetAuthor('eli');
$pdf->SetTitle('TCPDF Detalle_version');
$pdf->SetSubject('TCPDF Tutorial');
$pdf->SetKeywords('TCPDF, PDF, example, test, guide');

// set default header data
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE.'Evento de '.$data.$eventoVersion[0]['nombreV'], PDF_HEADER_STRING);
...
$titulo= <<<OED
    ...
    Se realizó la siguiente acción:
OED;
...
$text='Es el evento realizado en la version debe ser impreso y firmado por el Director de Coordinacion del Diplomado';
